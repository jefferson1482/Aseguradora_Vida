...
/* Table: CUBRE_POLIZA                                          */
/*==============================================================*/
create table CUBRE_POLIZA (
   CU_PO_ID             INT                  not null,
   POLI_ID              INT                  not null,
   CU_PO_INDIVIDUAL     CHAR(2)              null,
   CU_PO_COLECTIVOS     CHAR(2)              null,
   constraint PK_CUBRE_POLIZA primary key (CU_PO_ID)
);

/*==============================================================*/
insert into CUBRE_POLIZA values(1,1,'SI',null);
insert into CUBRE_POLIZA values(2,2,null,'SI');
insert into CUBRE_POLIZA values(3,3,'SI',null);
insert into CUBRE_POLIZA values(4,4,null,'SI');
insert into CUBRE_POLIZA values(5,5,'SI',null);
insert into CUBRE_POLIZA values(6,6,null,'SI');
...
/*==============================================================*/
insert into DETALLA_FACTURA values(1,'00001',1);
insert into DETALLA_FACTURA values(2,'00002',2);
insert into DETALLA_FACTURA values(3,'00003',3);
insert into DETALLA_FACTURA values(4,'00004',4);
insert into DETALLA_FACTURA values(5,'00005',5);
insert into DETALLA_FACTURA values(6,'00006',6);
...
alter table CUBRE_POLIZA
   add constraint FK_CUBRE_PO_RELATIONS_POLIZA foreign key (POLI_ID)
      references POLIZA (POLI_ID)
      on delete restrict on update restrict;

alter table DETALLA_FACTURA
   add constraint FK_DETALLA__RELATIONS_POLIZA foreign key (POLI_ID)
      references POLIZA (POLI_ID)
      on delete restrict on update restrict;
